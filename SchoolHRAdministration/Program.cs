...
namespace SchoolHRAdministration
{
    ...
    class Program
    {
        ...
        public static void SeedData(List<IEmployee> employees)
        {
            ...
            IEmployee deputyHeadMaster = EmployeeFactory.GetEmployeeInstance(EmployeeType.DeputyHeadMaster, 4, "Davlin", "Brown", 50000);
            employees.Add(deputyHeadMaster);

            IEmployee headMaster = EmployeeFactory.GetEmployeeInstance(EmployeeType.HeadMaster, 5, "Damien", "Jones", 50000);
